...
def main():
    ...
    parser.add_argument("--dump",action="store_true" ,help="Dump Users, Groups, Machine Accounts and their attributes")
    parser.add_argument("--dumpHashes",action="store_true" ,help="Dump Hashes")
